...
public class IronTomahawkProjectileModel extends EntityModel<IronTomahawkProjectileEntity> {
    public static final EntityModelLayer TOMAHAWK = new EntityModelLayer(Identifier.of(StarlightDelight.MOD_ID, "iron_tomahawk"), "main");
    private final ModelPart tomahawk;

    public IronTomahawkProjectileModel(ModelPart root) {
    ...
    @Override
    public void setAngles(IronTomahawkProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
