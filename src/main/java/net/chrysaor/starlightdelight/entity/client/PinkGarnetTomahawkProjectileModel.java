...
public class PinkGarnetTomahawkProjectileModel extends EntityModel<PinkGarnetTomahawkProjectileEntity> {
    public static final EntityModelLayer TOMAHAWK = new EntityModelLayer(Identifier.of(StarlightDelight.MOD_ID, "pink_garnet_tomahawk"), "main");
    private final ModelPart tomahawk;

    public PinkGarnetTomahawkProjectileModel(ModelPart root) {
    ...
    @Override
    public void setAngles(PinkGarnetTomahawkProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
