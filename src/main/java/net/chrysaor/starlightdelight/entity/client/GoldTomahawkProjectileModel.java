...
public class GoldTomahawkProjectileModel extends EntityModel<GoldTomahawkProjectileEntity> {
    public static final EntityModelLayer TOMAHAWK = new EntityModelLayer(Identifier.of(StarlightDelight.MOD_ID, "gold_tomahawk"), "main");
    private final ModelPart tomahawk;

    public GoldTomahawkProjectileModel(ModelPart root) {
    ...
    @Override
    public void setAngles(GoldTomahawkProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
