...
public class DiamondTomahawkProjectileModel extends EntityModel<DiamondTomahawkProjectileEntity> {
    public static final EntityModelLayer TOMAHAWK = new EntityModelLayer(Identifier.of(StarlightDelight.MOD_ID, "diamond_tomahawk"), "main");
    private final ModelPart tomahawk;

    public DiamondTomahawkProjectileModel(ModelPart root) {
    ...
    @Override
    public void setAngles(DiamondTomahawkProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
