...
public class ModItems {
    ...
    public static final Item CINNAMON_ROLL = registerItem("cinnamon_roll", new Item(new Item.Settings()
            .food(ModFoodComponents.CINNAMON_ROLL)));
    public static final Item RAW_RACLETTE = registerItem("raw_raclette", new Item(new Item.Settings()
    ...
    public static final Item APPLE_CRUMBLE = registerItem("apple_crumble", new Item(new Item.Settings()
    ...
    public static final Item PINK_GARNET_DOOR = registerItem("pink_garnet_door", new TallBlockItem(ModBlocks.PINK_GARNET_DOOR, new Item.Settings()));
