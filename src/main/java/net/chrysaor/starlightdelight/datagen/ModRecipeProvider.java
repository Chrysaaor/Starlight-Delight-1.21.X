...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.PEDESTAL)
                ...
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "pedestal"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.RAW_PINK_GARNET_BLOCK)
                ...
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "raw_pink_garnet_block_from_raw_pink_garnet"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE, 2)
                ...
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_upgrade_smithing_template"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_helmet_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_chestplate_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_leggings_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_boots_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_pickaxe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_axe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_shovel_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_sword_smithing"));

        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                Ingredient.ofItems(Items.BOW), Ingredient.ofItems(ModItems.STARLIGHT_FRAGMENT), RecipeCategory.COMBAT, ModItems.STARLIGHT_BOW)
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_bow_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_hoe_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE),
                ...
                .criterion(hasItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE), conditionsFromItem(ModItems.STARLIGHT_UPGRADE_SMITHING_TEMPLATE))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "starlight_hammer_smithing"));
        ...
        SmithingTransformRecipeJsonBuilder.create(Ingredient.ofItems(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE),
                ...
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "netherite_hammer_smithing"));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModItems.HOELY_BEHEADER)
                ...
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "hoely_beheader"));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAW_PINK_GARNET, 9)
                .input(ModBlocks.RAW_PINK_GARNET_BLOCK)
                .criterion(hasItem(ModBlocks.RAW_PINK_GARNET_BLOCK), conditionsFromItem(ModBlocks.RAW_PINK_GARNET_BLOCK))
                .offerTo(recipeExporter, Identifier.of(StarlightDelight.MOD_ID, "raw_pink_garnet_from_raw_pink_garnet_block"));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.REDSTONE, ModBlocks.PINK_GARNET_BUTTON, 1)
                ...
                .criterion(hasItem(ModItems.PINK_GARNET), conditionsFromItem(ModItems.PINK_GARNET))
                .offerTo(recipeExporter);
        offerPressurePlateRecipe(recipeExporter, ModBlocks.PINK_GARNET_PRESSURE_PLATE, ModItems.PINK_GARNET);
