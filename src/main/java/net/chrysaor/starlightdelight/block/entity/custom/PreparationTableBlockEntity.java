...
public class PreparationTableBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public PreparationTableBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.PREPARATION_TABLE_BE, pos, state);
    ...
    private void craftItem() {
        Optional<RecipeEntry<PreparationTableRecipe>> recipe = getCurrentRecipe();
    ...
    private Optional<RecipeEntry<PreparationTableRecipe>> getCurrentRecipe() {
        return this.getWorld().getRecipeManager()
                .getFirstMatch(ModRecipes.PREPARATION_TABLE_TYPE, new PreparationTableRecipeInput(inventory.get(INPUT_SLOT)), this.getWorld());
    }
