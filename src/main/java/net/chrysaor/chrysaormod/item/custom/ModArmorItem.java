...
import net.chrysaor.chrysaormod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private void addStatusEffectsForMaterial(PlayerEntity player, RegistryEntry<ArmorMaterial> mapArmorMaterial, List<StatusEffectInstance> mapStatusEffects) {
