...
public class ModTemplateItem extends SmithingTemplateItem {
    ...
    static {
        ...
        TRANSLATION_KEY = Util.createTranslationKey("item", Identifier.of(ChrysaorMod.MOD_ID, "smithing_template"));
        ...
        STARLIGHT_UPGRADE_TEXT = Text.translatable(Util.createTranslationKey("upgrade", Identifier.of(ChrysaorMod.MOD_ID, "starlight_upgrade"))).formatted(TITLE_FORMATTING);
        STARLIGHT_UPGRADE_APPLIES_TO_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(ChrysaorMod.MOD_ID, "smithing_template.starlight_upgrade.applies_to"))).formatted(DESCRIPTION_FORMATTING);
        STARLIGHT_UPGRADE_INGREDIENTS_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(ChrysaorMod.MOD_ID, "smithing_template.starlight_upgrade.ingredients"))).formatted(DESCRIPTION_FORMATTING);
        STARLIGHT_UPGRADE_BASE_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(ChrysaorMod.MOD_ID, "smithing_template.starlight_upgrade.base_slot_description")));
        STARLIGHT_UPGRADE_ADDITIONS_SLOT_DESCRIPTION_TEXT = Text.translatable(Util.createTranslationKey("item", Identifier.of(ChrysaorMod.MOD_ID, "smithing_template.starlight_upgrade.additions_slot_description")));
    }
}