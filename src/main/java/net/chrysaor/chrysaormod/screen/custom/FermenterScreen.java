package net.chrysaor.chrysaormod.screen.custom;
...
public class FermenterScreen extends HandledScreen<FermenterScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(ChrysaorMod.MOD_ID, "textures/gui/fermenter/fermenter_gui.png");
    private static final Identifier ARROW_TEXTURE =
            Identifier.of(ChrysaorMod.MOD_ID, "textures/gui/fermenter/ferment_progress.png");
