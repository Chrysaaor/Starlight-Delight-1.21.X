...
execute if entity @s[nbt={SelectedItem:{id:"chrysaormod:starlight_hoe"}}] unless predicate farm3:is_sneaking at @s anchored eyes positioned ^ ^ ^2 at @e[type=item,distance=..2,nbt={Age:0s}] run function #harvest
